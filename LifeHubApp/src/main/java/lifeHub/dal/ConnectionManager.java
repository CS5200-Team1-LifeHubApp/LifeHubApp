...
public class ConnectionManager {
	...
	private final String password = "Something"; // changes based on your personal password!!!
	...
	private final String schema = "LifeHubApp"; // need to make sure the data in the SQL file is named the same for everyone. 
